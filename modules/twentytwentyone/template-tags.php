...
if (!function_exists('twenty_twenty_one_the_posts_navigation')) {
	...
	function twenty_twenty_one_the_posts_navigation()
	{
		the_posts_pagination(
			array(
				'before_page_number' => esc_html__('Pág.', 'twentytwentyone') . ' ',
				'mid_size'           => 0,
				'prev_text'          => sprintf(
					'%s <span class="nav-prev-text">%s</span>',
					is_rtl() ? twenty_twenty_one_get_icon_svg('ui', 'arrow_right') : twenty_twenty_one_get_icon_svg('ui', 'arrow_left'),
					wp_kses(
						__('Pág. <span class="nav-short">Anterior</span>', 'twentytwentyone'),
						array(
							'span' => array(
								'class' => array(),
							),
				...
				'next_text'          => sprintf(
					...
					wp_kses(
						__('Pág. <span class="nav-short">Siguiente</span>', 'twentytwentyone'),
						array(
							'span' => array(
								'class' => array(),
							),
