 ...
 ****************************/
function fgh001_crea_etiquetas_evento($singular = 'Post', $plural = 'Posts')
{
   ...
   return [
      ...
      'add_new'                  => _x("New $singular", 'prayer', 'fgh001'),
      'add_new_item'             => __("Add $singular", 'fgh001'),
      'new_item'                 => __("New $singular", 'fgh001'),
      'edit_item'                => __("Edit $singular", 'fgh001'),
      'view_item'                => __("View $singular", 'fgh001'),
      'view_items'               => __("View $plural", 'fgh001'),
      'all_items'                => __("All $plural", 'fgh001'),
      'search_items'             => __("Search $plural", 'fgh001'),
      ...
      'insert_into_item'         => __("Insert into $s_lower", 'fgh001'),
      'uploaded_to_this_item'    => __("Uploaded to this $s_lower", 'fgh001'),
   ];
}
/****************************
 * Aplica capacidades al post
 ***************************/
function fgh001_aplicar_capacidades_evento($singular = 'post', $plural = 'posts')
{
   return [
 ...
 ***************************/
function fgh001_evento_post_type()
{
   $type = 'evento';
   $labels = fgh001_crea_etiquetas_evento('Evento', 'Eventos');
...
add_action('init', 'fgh001_evento_post_type');
/***********************************
 * Creación de campos personalizados 
 **********************************/
function fgh001_crear_campos_evento()
{
   add_meta_box(
      'f_inicio',                     // Unique ID     
      'Fecha Inicio',                     // Title
      'fgh001_crear_f_inicio_cbk',   // Callback function
      'evento',                   // Admin page (or post type)
      'normal',                     // Context
      'default',                     // Priority
      'show_in_rest'
   );
   function fgh001_crear_f_inicio_cbk($post)
   {
   ...
   add_meta_box(
      'h_inicio',
      'Hora Inicio',
      'fgh001_crear_h_inicio_cbk',
      'evento',
      'normal',
      'default',
      'show_in_rest',
   );
   function fgh001_crear_h_inicio_cbk($post)
   {
   ...
   add_meta_box(
      'f_final',
      'Fecha Final',
      'fgh001_crear_f_final_cbk',
      'evento',
      'normal',
      'default',
      'show_in_rest',
   );
   function fgh001_crear_f_final_cbk($post)
   {
   ...
   add_meta_box(
      'h_final',
      'Hora Final',
      'fgh001_crear_h_final_cbk',
      'evento',
      'normal',
      'default',
      'show_in_rest',
   );
   function fgh001_crear_h_final_cbk($post)
   {
   ...
   add_meta_box(
      'dia_completo',
      'Evento Día Completo',
      'fgh001_crear_dia_completo_cbk',
      'evento',
      'normal',
      'default',
      'show_in_rest',
   );
   function fgh001_crear_dia_completo_cbk($post)
   {
   ...
   add_meta_box(
      'periodicidadevento',
      'Tipo de Evento',
      'fgh001_crear_periodicidadevento_cbk',
      'evento',
      'normal',
      'default',
      'show_in_rest',
   );
   function fgh001_crear_periodicidadevento_cbk($post)
   {
...
?>
   ...
   add_meta_box(
      ...
      'fgh001_crear_inscripcion_cbk',
      'evento',
      'normal',
      'default',
      'show_in_rest',
   );
   function fgh001_crear_inscripcion_cbk($post)
   {
   ...
   add_meta_box(
      'donativo',
      'Requiere donativo',
      'fgh001_crear_donativo_cbk',
      'evento',
      'normal',
      'default',
      'show_in_rest',
   );
   function fgh001_crear_donativo_cbk($post)
   {
   ...
   add_meta_box(
      ...
      'fgh001_crear_montodonativo_cbk',
      'evento',
      'normal',
      'default',
      'show_in_rest',
   );
   function fgh001_crear_montodonativo_cbk($post)
   {
   ...
   add_meta_box(
      ...
      'fgh001_crear_opcionesquema_cbk',
      'evento',
      'normal',
      'default',
      'show_in_rest',
   );
   function fgh001_crear_opcionesquema_cbk($post)
   {
   ...
   add_meta_box(
      'npereventos',
      'Número de períodos',
      'fgh001_crear_npereventos_cbk',
      'evento',
      'normal',
      'default',
      'show_in_rest',
   );
   function fgh001_crear_npereventos_cbk($post)
   {
   ...
   add_meta_box(
      'diasemanaevento',
      'Día de la Semana',
      'fgh001_crear_diasemanaevento_cbk',
      'evento',
      'normal',
      'default',
      'show_in_rest',
   );
   function fgh001_crear_diasemanaevento_cbk($post)
   {
   ...
   add_meta_box(
      ...
      'fgh001_crear_numerodiaevento_cbk',
      'evento',
      'normal',
      'default',
      'show_in_rest',
   );
   function fgh001_crear_numerodiaevento_cbk($post)
   {
   ...
   add_meta_box(
      ...
      'fgh001_crear_numerodiaordinalevento_cbk',
      'evento',
      'normal',
      'default',
      'show_in_rest',
   );
   function fgh001_crear_numerodiaordinalevento_cbk($post)
   {
   ...
   add_meta_box(
      'mesevento',
      'Mes del año',
      'fgh001_crear_mesevento_cbk',
      'evento',
      'normal',
      'default',
      'show_in_rest',
   );
   function fgh001_crear_mesevento_cbk($post)
   {
...
<?php
   ...
   add_meta_box(
      ...
      'fgh001_crear_f_proxevento_cbk',
      'evento',
      'normal',
      'default',
      'show_in_rest',
   );
   function fgh001_crear_f_proxevento_cbk($post)
   {
...
add_action('add_meta_boxes', 'fgh001_crear_campos_evento');
...
function fgh001_guardar_evento_f_inicio($post_id)
{
...
add_action('save_post', 'fgh001_guardar_evento_f_inicio');

function fgh001_guardar_h_inicio($post_id)
{
...
add_action('save_post', 'fgh001_guardar_h_inicio');

function fgh001_guardar_evento_f_final($post_id)
{
...
add_action('save_post', 'fgh001_guardar_evento_f_final');

function fgh001_guardar_h_final($post_id)
{
...
add_action('save_post', 'fgh001_guardar_h_final');

function fgh001_guardar_dia_completo($post_id)
{
...
add_action('save_post', 'fgh001_guardar_dia_completo');

function fgh001_guardar_periodicidadevento($post_id)
{
...
add_action('save_post', 'fgh001_guardar_periodicidadevento');

function fgh001_guardar_inscripcion($post_id)
{
...
add_action('save_post', 'fgh001_guardar_inscripcion');

function fgh001_guardar_donativo($post_id)
{
...
add_action('save_post', 'fgh001_guardar_donativo');

function fgh001_guardar_montodonativo($post_id)
{
...
add_action('save_post', 'fgh001_guardar_montodonativo');

function fgh001_guardar_opcionesquema($post_id)
{
...
add_action('save_post', 'fgh001_guardar_opcionesquema');


function fgh001_guardar_npereventos($post_id)
{
...
add_action('save_post', 'fgh001_guardar_npereventos');

function fgh001_guardar_diasemanaevento($post_id)
{
...
add_action('save_post', 'fgh001_guardar_diasemanaevento');

function fgh001_guardar_numerodiaevento($post_id)
{
...
add_action('save_post', 'fgh001_guardar_numerodiaevento');

function fgh001_guardar_numerodiaordinalevento($post_id)
{
...
add_action('save_post', 'fgh001_guardar_numerodiaordinalevento');

function fgh001_guardar_mesevento($post_id)
{
...
add_action('save_post', 'fgh001_guardar_mesevento');

function fgh001_guardar_f_proxevento($post_id)
{
...
add_action('save_post', 'fgh001_guardar_f_proxevento');
