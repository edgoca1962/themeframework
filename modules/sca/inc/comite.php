 ...
 * 
 *****************************************************************************/
function themeframework_crea_etiquetas_comite($singular = 'Post', $plural = 'Posts')
{
 ...
 * 
 *****************************************************************************/
function themeframework_capacidades_comite($singular = 'post', $plural = 'posts')
{
   return [
 ...
 * 
 *****************************************************************************/
function themeframework_comite_post_type()
{
   $type = 'comite';
   $labels = themeframework_crea_etiquetas_comite('comite', 'comites');
   $capabilities = themeframework_capacidades_comite('comite', 'comites');
...
add_action('init', 'themeframework_comite_post_type');
/******************************************************************************
 * 
 * 
 ...
 * 
 *****************************************************************************/
function themeframework_orden_comites($query)
{
...
add_action('pre_get_posts', 'themeframework_orden_comites');
